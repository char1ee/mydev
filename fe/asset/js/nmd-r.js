// http://s0.qhimg.com/static/da3e015a8934450d.js
...
(function(window, document, arrPro, strPro, objPro) {
    ...
    // forEach
    arrPro.forEach = arrPro.forEach || function(callback) {
        00
        var _this = this;
            ...
            stringify: function(o) {
                ...
                function parseArray(arr) {
                    ...
                    for (var i = 0, l = arr.length; i < l; ++i) {
                        if (!is('Array', arr[i]) && !is('Object', arr[i])) {
                            if (is('String', arr[i])) {
                                s += '"' + arr[i].replace(/\"/g, '\\"') + '",';
...
require.config({
    // baseUrl: "/asset/js/amd_moudles",
    // paths: {
    //   "jquery": "/asset/js/vendor/jquery/jquery",
